    ...
    open override func drawValues(context: CGContext)
    {
        ...
        for i in 0 ..< dataSets.count
        {
            ...
            for j in 0 ..< dataSet.entryCount
            {
                ...
                /*
                 根据数据算出来的百分比, 如果它<6%, 饼状图上面的折线和文字就不展示
                 */
                ...
                if drawXOutside || drawYOutside
                {
                    ...
                    /*
                     这里是绘制圈外线,必须添加(
                     */
                    if dataSet.valueLineColor != nil && value > 6 //画两条折线的方法
                    {
                    ...
                    /*
                     这里是绘制圈外线,必须添加
                     */
                    if drawXOutside && drawYOutside && value > 6 //画文字的方法
                    {
                        ChartUtils.drawText(
                            context: context,
                            text: valueText,
                    ...
                    else if drawXOutside
                    {
                        /*
                         这里是绘制圈外线,必须添加
                         */
                        if j < data.entryCount && pe?.label != nil && value > 6
                        {
                            ChartUtils.drawText(
                                context: context,
                                text: pe!.label!,
