...
@interface KCResultViewController ()<UITextFieldDelegate>
...
- (void)createUI
{
    ...
    //卡号截图
    cardImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, lastY, ZSWIDTH, ZSWIDTH * 0.632)];
    [scr addSubview:cardImageView];
    lastY = lastY + ZSWIDTH * 0.632 + 20;
    
    //卡号编辑框
    if (![BankInfo getNoShowBANKCardNum]) {
        cardNumView = [[UITextView alloc]initWithFrame:CGRectMake(0, lastY-borderWidth, ZSWIDTH, labelHeight*1.5+borderWidth*2)];
