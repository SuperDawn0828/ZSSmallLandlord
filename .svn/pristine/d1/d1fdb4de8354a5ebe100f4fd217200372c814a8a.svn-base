...
#define TRectW(rect)  ((rect.nRgt)- (rect.nLft)+1)
#define TRectH(rect)  ((rect.nBtm)- (rect.nTop)+1)
#define PRectW(rect)  ((rect->nRgt)- (rect->nLft)+1)
#define PRectH(rect)  ((rect->nBtm)- (rect->nTop)+1)
