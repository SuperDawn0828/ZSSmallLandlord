//
//  ZSRFOrderDetailsModel.h
//  ZSSmallLandlord
//
//  Created by gengping on 17/7/21.
//  Copyright © 2017年 黄曼文. All rights reserved.
//

#import <Foundation/Foundation.h>

@class SpdOrderStates,BizCustomers,SpdOrder,OrderRelation;

@interface ZSRFOrderDetailsModel : NSObject

@property (nonatomic , strong)  NSArray<SpdOrderStates *>   * redeemOrderStates;  //订单进度

@property (nonatomic , strong)  NSArray<BizCustomers *>     *bizCustomers;        //人员信息

@property (nonatomic , strong)  SpdOrder   *redeemOrder;                          //贷款信息和房产信息
