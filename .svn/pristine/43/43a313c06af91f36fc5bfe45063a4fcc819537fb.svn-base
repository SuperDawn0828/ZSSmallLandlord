...
- (void)createUI
{
    ...
    CGRect frontFrame = CGRectMake(ZSWIDTH - 50, lastY + 40, 40, 30);
    ...
    CGRect backFrame = CGRectMake(ZSWIDTH - 50, lastY, 40, 30);
...
//                                                                                    + validValueTextField.frame.size.height + 5, ZSWIDTH - 10, (ZSWIDTH - 10) * 0.632)];
