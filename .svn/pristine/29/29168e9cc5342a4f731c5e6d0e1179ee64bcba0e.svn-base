...
+ (void) initialize
{
    if (self == [DACircularProgressView class]) {
        ...
        [circularProgressViewAppearance setTrackTintColor:[ZSColorWhite colorWithAlphaComponent:0.3f]];
        [circularProgressViewAppearance setProgressTintColor:ZSColorWhite];
