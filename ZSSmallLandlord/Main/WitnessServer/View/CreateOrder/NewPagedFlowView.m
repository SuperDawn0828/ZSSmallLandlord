...
#pragma mark 滑到第几页
- (void)indexpage:(NSInteger)index{
    switch (self.orientation) {
        case NewPagedFlowViewOrientationHorizontal:{
            [_scrollView setContentOffset:CGPointMake(index * _pageSize.width, 0) animated:YES];
            break;
        }
        case NewPagedFlowViewOrientationVertical:{
            
            [_scrollView setContentOffset:CGPointMake(0, index * _pageSize.height) animated:YES];
...
- (void)reloadData
{
    ...
    if (_needsReload) {
        ...
        if (_dataSource && [_dataSource respondsToSelector:@selector(numberOfPagesInFlowView:)]) {
            ...
            //总页数
            _pageCount = self.orginPageCount == 1 ? 1: [_dataSource numberOfPagesInFlowView:self] * 1;
        ...
        switch (self.orientation) {
            case NewPagedFlowViewOrientationHorizontal://横向
                ...
                if (self.orginPageCount > 1) {
                    //滚到第二组
//                    [_scrollView setContentOffset:CGPointMake(_pageSize.width * self.orginPageCount, 0) animated:YES];
//                    
...
//                    
//                    [scrollView setContentOffset:CGPointMake(_pageSize.width * self.orginPageCount, 0) animated:YES];
//                    
//                    self.page = self.orginPageCount;
//                    
//                    }
...
//                        [scrollView setContentOffset:CGPointMake((2 * self.orginPageCount - 1) * _pageSize.width, 0) animated:YES];
//                        
...
//                    
//                    [scrollView setContentOffset:CGPointMake(0, _pageSize.height * self.orginPageCount) animated:YES];
//                    
//                    self.page = self.orginPageCount;
//                    
//                    }
...
//                    [scrollView setContentOffset:CGPointMake(0, (2 * self.orginPageCount - 1) * _pageSize.height) animated:YES];
//                    self.page = 2 * self.orginPageCount;
//                    }
//
//            }
