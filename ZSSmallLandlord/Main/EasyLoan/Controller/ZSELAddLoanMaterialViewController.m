//
//  ZSELAddLoanMaterialViewController.m
//  ZSSmallLandlord
//
//  Created by 黄曼文 on 2018/11/7.
...
@interface ZSELAddLoanMaterialViewController ()<ZSActionSheetViewDelegate,ZSPickerViewDelegate>
...
@implementation ZSELAddLoanMaterialViewController
...
- (void)displayContent
{
    SpdOrder *model = global.elOrderDetails.easyOrder;
...
- (void)requestForCloseOrderData
{
    __weak typeof(self) weakSelf = self;
    NSMutableDictionary *parameterDict = @{
                                           @"orderId":global.elOrderDetails.easyOrder.tid,
...
- (void)requestEditOrderData:(BOOL)isGoBack
{
    ...
    [ZSRequestManager requestWithParameter:[weakSelf getEditOrderParameter:YES] url:[ZSURLManager getEasyLoanUpdateMortgageInfoURL] SuccessBlock:^(NSDictionary *dic) {
        //        ZSLOG(@"成功");
        [LSProgressHUD hide];
        //下一个界面
