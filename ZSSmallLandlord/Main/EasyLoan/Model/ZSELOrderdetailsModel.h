//
//  ZSELOrderDetailModel.h
//  ZSSmallLandlord
//
//  Created by 黄曼文 on 2018/11/5.
...
@interface ZSELOrderdetailsModel : NSObject

@property (nonatomic , strong)  NSArray<SpdOrderStates *>   * easyOrderStates;    //订单进度

@property (nonatomic , strong)  NSArray<BizCustomers *>   * bizCustomers;         //人员信息

@property (nonatomic , strong)  SpdOrder   *easyOrder;                            //贷款信息和房产信息
