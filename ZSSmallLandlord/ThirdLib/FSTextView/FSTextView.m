...
CGFloat const kFSTextViewPlaceholderVerticalMargin = 10.0; ///< placeholder垂直方向边距
CGFloat const kFSTextViewPlaceholderHorizontalMargin = 10.0; ///< placeholder水平方向边距
...
- (void)initialize {
    ...
    if (!_placeholderColor) _placeholderColor = ZSColorAllNotice;
    
    // 基本设定 (需判断是否在Storyboard中设置了值)
    if (!self.backgroundColor) self.backgroundColor = ZSColorWhite;
