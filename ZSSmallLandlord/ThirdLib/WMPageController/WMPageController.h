...
@interface WMPageController : ZSBaseViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
...
@property (nonatomic, strong, readwrite) ZSBaseViewController *currentViewController;
